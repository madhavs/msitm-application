...
describe('Employee e2e test', () => {
  ...
  it('should load Employees', async () => {
    ...
    expect(await employeeComponentsPage.getTitle()).to.eq('msitmApplicationApp.employee.home.title');
  ...
  it('should load create Employee page', async () => {
    ...
    expect(await employeeUpdatePage.getPageTitle()).to.eq('msitmApplicationApp.employee.home.createOrEditLabel');
  ...
  it('should delete last Employee', async () => {
    ...
    expect(await employeeDeleteDialog.getDialogTitle()).to.eq('msitmApplicationApp.employee.delete.question');
