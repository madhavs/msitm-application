...
describe('Job e2e test', () => {
  ...
  it('should load Jobs', async () => {
    ...
    expect(await jobComponentsPage.getTitle()).to.eq('msitmApplicationApp.job.home.title');
  ...
  it('should load create Job page', async () => {
    ...
    expect(await jobUpdatePage.getPageTitle()).to.eq('msitmApplicationApp.job.home.createOrEditLabel');
  ...
  it('should delete last Job', async () => {
    ...
    expect(await jobDeleteDialog.getDialogTitle()).to.eq('msitmApplicationApp.job.delete.question');
